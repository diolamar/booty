...
class AutomationEngine:
    ...
    def _handle_gray_board_cooldown(self, prefix: str) -> bool:
        message = f"{prefix}: gray board detected, cycle counter reset. Pending bet preserved."
    ...
    def _monitor_loop(self):
        ...
        last_round_signature: Optional[Tuple[Tuple[int, Tuple[str, ...]], ...]] = None
        ...
        while not self._stop_event.is_set():
            ...
            with self.capture_mgr.capture_region() as (screenshot, bbox):
                ...
                if self._is_full_gray_board(game_state):
                    self._handle_gray_board_cooldown("LIVE")
