...
class AutomationEngine:
    ...
    def start_simulation(self) -> bool:
        ...
        self._simulate_halted = False
        self._clear_pending_bet()
        self._awaiting_cycle_reset_sync = True
    ...
    def _is_cycle_reset_state(self, game_state: Optional[GameState]) -> bool:
        ...
        # Hard reset only when the whole board is blank, confidence is 0,
        # and the calibrated blank witness area is visible.
        return game_state.blank_detected and game_state.blank_reference_visible
...
class AutoClickerPro:
    ...
    def _setup_ui(self):
        ...
        window_width = getattr(self.config, "ui_window_width", 560)
        desired_window_height = getattr(self.config, "ui_preferred_window_height", 800)
        min_window_height = getattr(self.config, "ui_min_window_height", 540)
        screen_margin = getattr(self.config, "ui_window_screen_margin", 20)
...
"""
    ...
    def _update_ui(self):
        ...
        if self._calibration_window:
            ...
            self.status_var.set(f"Status: {self.status_mode_label} - SYNC WAIT (waiting for blank reset)")
