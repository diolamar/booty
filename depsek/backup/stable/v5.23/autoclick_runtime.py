...
EXACT_STAGE_PLANS: Dict[int, List[Tuple[int, str, int]]] = {
    5: [(0, "Bet 5", 0)],
    15: [(0, "Bet 10", 0), (10, "Bet 5", 0)],
    35: [(0, "Bet 20", 0), (20, "Bet 10", 0), (30, "Bet 5", 0)],
    75: [(0, "Bet 50", 0), (50, "Bet 20", 0), (70, "Bet 5", 0)],
    155: [(0, "Bet 50", 1), (100, "Bet 50", 0), (150, "Bet 5", 0)],
    315: [(0, "Bet 50", 1), (100, "Bet 50", 1), (300, "Bet 10", 0), (310, "Bet 5", 0)],
    635: [(0, "Bet 50", 1), (100, "Bet 20", 1), (240, "Bet 50", 1), (580, "Bet 50", 0), (630, "Bet 5", 0)],
    1275: [(0, "Bet 50", 1), (100, "Bet 50", 3), (1200, "Bet 50", 0), (1250, "Bet 20", 0), (1270, "Bet 5", 0)],
    2555: [(0, "Bet 50", 1), (100, "Bet 50", 3), (1200, "Bet 50", 1), (2500, "Bet 50", 0), (2550, "Bet 5", 0)],
    3830: [(0, "Bet 50", 3), (400, "Bet 10", 0), (410, "Bet 50", 2), (1840, "Bet 50", 1), (3780, "Bet 50", 0)],
    6385: [(0, "Bet 20", 0), (20, "Bet 50", 1), (140, "Bet 50", 3), (1520, "Bet 50", 1), (3140, "Bet 50", 1), (6380, "Bet 5", 0)],
    10215: [(0, "Bet 50", 1), (100, "Bet 50", 3), (1200, "Bet 50", 1), (2500, "Bet 50", 2), (10200, "Bet 10", 0), (10210, "Bet 5", 0)],
    16600: [(0, "Bet 50", 2), (200, "Bet 50", 3), (2000, "Bet 50", 1), (4100, "Bet 50", 2)],
}
...
class BetPlacement:
    ...
    def description(self) -> str:
        if self.x2_clicks <= 0:
            return (
                f"from {self.starting_total}: +{self.added_amount} via "
                f"{self.chip_label} -> {self.resulting_total}"
            )
        return (
            f"from {self.starting_total}: +{self.added_amount} via {self.chip_label}, "
            f"then X2x{self.x2_clicks} -> {self.resulting_total}"
        )
...
def build_bet_plan(target_amount: int) -> List[BetPlacement]:
    ...
    exact_plan = EXACT_STAGE_PLANS.get(target_amount)
    if exact_plan is not None:
        placements: List[BetPlacement] = []
        for starting_total, chip_label, x2_clicks in exact_plan:
            chip_value = CHIP_VALUES[chip_label]
            resulting_total = (starting_total + chip_value) * (2 ** x2_clicks)
            placements.append(
                BetPlacement(
